...
five_prec[["percent.mt"]] <- PercentageFeatureSet(five_prec, pattern = "^MT-")
...
```{r}
plot1 <- FeatureScatter(five_prec, feature1 = "nCount_RNA", feature2 = "percent.mt") 
plot2 <- FeatureScatter(five_prec, feature1 = "nCount_RNA", feature2 = "nFeature_RNA") 
plot1 + plot2
